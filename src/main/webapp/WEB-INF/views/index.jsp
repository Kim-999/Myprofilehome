...
<%@ include file="include/header.jsp" %>
	...
	<table width="75%" border="0" cellpadding="20" cellspacing="0">
		...
		<tr align="center">
			<td>
				<span class="title02">A developer who wants a development job. Please call me back.</span>
			</td>
		</tr>
		<tr>
			<td>
				...
				<table width="80%" border="0" cellpadding="10" cellspacing="0">
					<tr>
						...
						<td align="center" rowspan="6" style="background-color: #86E5FF"><img src="/resources/img/산리오.png"></td>
					</tr>
					<tr>
